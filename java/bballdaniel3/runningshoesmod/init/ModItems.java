...
public class ModItems {
	...
	public static final ArmorMaterial ARMOR_RUNNING_SHOES = EnumHelper.addArmorMaterial("running_shoes", Reference.MOD_ID + ":running_shoes", 5, new int[]{1, 2, 3, 0}, 15, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 0.0F);
	public static final ArmorMaterial ARMOR_LEATHER_RUNNING_SHOES = EnumHelper.addArmorMaterial("running_shoes", Reference.MOD_ID + ":leather_running_shoes", 5, new int[]{1, 2, 3, 1}, 15, SoundEvents.ITEM_ARMOR_EQUIP_LEATHER, 0.0F);
	...
	public static final Item RUNNING_SHOES = new ArmorBase("running_shoes", ARMOR_RUNNING_SHOES, 1, EntityEquipmentSlot.FEET, 0);
	public static final Item LEATHER_RUNNING_SHOES = new ArmorBase("leather_running_shoes", ARMOR_LEATHER_RUNNING_SHOES, 1, EntityEquipmentSlot.FEET, 0);
	...
	public static final Item GOLD_SPRINTING_SHOES = new ArmorBase("gold_sprinting_shoes", ARMOR_GOLD_RUNNING_SHOES, 1, EntityEquipmentSlot.FEET, 1);
	public static final Item DIAMOND_SPRINTING_SHOES = new ArmorBase("diamond_sprinting_shoes", ARMOR_DIAMOND_RUNNING_SHOES, 1, EntityEquipmentSlot.FEET, 1);
}
